...
String [] dialogos = {"Autor: \n Jorge Luis Borges \n  \n Personajes: \n Jorge Luis Borges de 1972 \n Jorge Luis Borges de 1969",
  ...
  "Claramente no lo permití, creo que se\nquedo un poco enojado, pero preferia eso\nantes que todo quede patas para arriba.", "Creditos", "Comenzar", "Me voy", "Me quedo", "Se va", "Se queda", "Final 1", "Final 2", "Acepto", "Rechazo", "Fin", "Volver", "Seguir"};
